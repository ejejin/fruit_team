...
void Loss_read()
{
    string Str = "loss_KIN_EN2000000_LN5_E1000_NN256_B500_adam_L1e-05_DR0.0.txt";
//    string Str = "loss_MEM_EN713050_LN4_E1000_NN128_B500_adam_L1e-05_DR0.0.txt";
//	string Str = "loss_MEM_EN713050_LN3_E1000_NN128_B500_adam_L1e-05_DR0.0.txt";
