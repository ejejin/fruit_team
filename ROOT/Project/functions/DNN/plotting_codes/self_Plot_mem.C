...
void self_Plot_mem(){
  ...
  TFile* f = new TFile("../self_tree_EN1000_LN5_E100_NN100_B10_adam_L1e-05_DR0.0.root","READ");
//  TFile* f = new TFile("../self_trees/self_tree_mem_EN713050_LN4_E1000_NN128_B500_adam_L1e-05_DR0.0.root","READ");
//  TFile* f = new TFile("../self_trees/self_tree_kin_EN2000000_LN5_E1000_NN256_B500_adam_L1e-05_DR0.0.root","READ");
