...
def CONVERT_WORKING_largeBin(filename, outputpath = "" ):
...
#    Name_Output_File = FileNameList[0] + "_hist.root"
    Name_Output_File = Name_Output_File.replace(Name_Output_File[-5:-1],'')
    Name_Output_File = Name_Output_File+"_LARGEBIN.root"
...
def main():
    CONVERT_WORKING_largeBin("root2_tree_cut_tree.root")
