...
void n23_ratioplot1_TRatioPlot()
{
...
//    c1->SetTicks(0,1);   //!!!!!!???? make a mark ???
    rp->Draw();   // h1 would be drwan in fashion of histogram, while h2 in shape of dot
    rp->GetLowYaxis()->SetNdivisions(505);  // !!!!!!! Get bottom side Y axis, an set number of divisions 
    c1->Update();
