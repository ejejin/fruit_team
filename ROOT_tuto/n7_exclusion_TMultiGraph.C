...
//TCanvas* n7_exclusion_TMultiGraph()
void n7_exclusion_TMultiGraph()
{
    TCanvas *c1 = new TCanvas("c1","Exclusion graphs example", 200,10,600,400);
    c1->SetGrid();   // ?????? what is this????
